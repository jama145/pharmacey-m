<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Employees.aspx.vb" Inherits="fullprojec.Employees" %>
        ...
        <div class="container-fluid">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title   align-content-center">Employee Information</h4>
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="dropdownlistGender" runat="server" Height="19px" Width="130px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DropDownlistbllood" runat="server" Height="22px" Width="139px">
                        ...
                        <div class="row">
                            <div class=" col-3">
                                ...
                                <asp:Button ID="BtInsert" runat="server" Text="Insert "  cssclass="btn btn-primary pull-right btn-round" />
          ...
          <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" Width="888px" BackColor="White" CellPadding="7"></asp:GridView>
          </div>
        </div>
      <footer class="footer">
        <div class="container-fluid">
